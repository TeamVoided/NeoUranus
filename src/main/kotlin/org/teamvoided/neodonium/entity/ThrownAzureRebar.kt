package org.teamvoided.neodonium.entity
...
class ThrownAzureRebar : AbstractThrownRebar {
    ...
    constructor(world: Level) : this(NeoEntities.THROWN_AZURE_REBAR.get(), world)
    constructor(level: Level, x: Double, y: Double, z: Double)
            : super(NeoEntities.THROWN_AZURE_REBAR.get(), level, x, y, z)

    constructor(shooter: LivingEntity, level: Level) : super(NeoEntities.THROWN_AZURE_REBAR.get(), shooter, level)
