...
object NeoBlocks {
    val BLOCKS: DeferredRegister<Block> = DeferredRegister.create(ForgeRegistries.BLOCKS, Neodonium.ID)
    ...
    private fun regBlockWItem(id: String, creativeTab: Boolean = true, supplier: () -> Block):
        ...
        NeoItems.regItem(id, creativeTab) { BlockItem(block.get(), Item.Properties()) }
